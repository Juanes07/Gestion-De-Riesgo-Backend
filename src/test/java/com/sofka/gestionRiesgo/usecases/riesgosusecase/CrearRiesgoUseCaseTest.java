...
class CrearRiesgoUseCaseTest {
    ...
    @Test
    void getValidationCreateBadTestCase() {
        ...
        StepVerifier.create(crearRiesgoUseCase.apply(riesgoDTO))
                .expectErrorMessage("El proyecto se encuentra en estado "
                        + proyecto.getEstado() + " y no se puede crear un riesgo").verify();
